    ...
    <div className="employee-table">
      <ul>
        ...
        <li className="employee-table__row data">
            <h2>Request Leave:</h2>
            <p>Starting Date:</p>
            <input onChange={(e)=>setStartingDate(e.target.value)}type="date" placeholder="Enter Starting Date"></input>
            <p>Enter Duration:</p>
            <input onChange={(e)=>setDuration(e.target.value)} type="text" placeholder="Enter Duration of Leave in days"></input>
            <p>Enter Valid Reason for leave:</p>
            <input onChange={(e)=>setReason(e.target.value)} type="text" placeholder="Reason"></input>
